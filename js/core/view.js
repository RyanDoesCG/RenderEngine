class View
{
    ...
    constructor(CameraPosition, CameraRotation, Width, Height, Aspect, Near, Far, FoV, jitter)
    {
        this.Near = Near
        this.Far = Far
        this.FoV = FoV

        this.ProjectionMatrix = perspective(FoV, Near, Far, Width, Height, Aspect, jitter)
